...
const adminData = {
  ...
  users: [
    ...
    { id: 2, name: "Stephanie Danso", email: "s.danso@gmail.com", courses: 1, status: "inactive" },
    ...
    { id: 5, name: "Emmanuel Ansah", email: "e.ansah@gmail.com", courses: 1, status: "uncompleted" },
    ...
    { id: 10, name: "Khadijah Wiafe", email: "k.wiafe@gmail.com", courses: 3, status: "uncompleted" },
    ...
    { id: 13, name: "Raphael Anaba", email: "r.anaba@gmail.com", courses: 1, status: "inactive" },
