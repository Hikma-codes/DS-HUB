...
const adminData = {
  ...
  users: [
    { id: 1, name: "Esi Micah", email: "alice@example.com", courses: 2, status: "active" },
    { id: 2, name: "Stephanie Danso", email: "bob@example.com", courses: 1, status: "active" },
    { id: 3, name: "Cecil Essel", email: "carol@example.com", courses: 1, status: "active" },
    { id: 4, name: "Sedoh Julius", email: "david@example.com", courses: 3, status: "completed" },
    { id: 5, name: "Emmanuel Ansah", email: "emma@example.com", courses: 1, status: "active" },
    { id: 6, name: "Portia Munku", email: "frank@example.com", courses: 2, status: "active" },
    { id: 7, name: "Christabel Amofa", email: "grace@example.com", courses: 2, status: "active" },
    { id: 8, name: "Emmanuel Amofa", email: "henry@example.com", courses: 1, status: "active" },
    { id: 9, name: "Esther Kpeglo", email: "iris@example.com", courses: 2, status: "active" },
    { id: 10, name: "Khadijah Wiafe", email: "jack@example.com", courses: 3, status: "completed" },
    { id: 11, name: "Isabella Biney", email: "karen@example.com", courses: 1, status: "active" },
    { id: 12, name: "Nsobila Godfred", email: "leo@example.com", courses: 2, status: "active" },
    { id: 13, name: "Raphael Anaba", email: "maya@example.com", courses: 1, status: "active" },
    { id: 14, name: "Daniella Sackey", email: "noah@example.com", courses: 2, status: "active" },
    { id: 15, name: "Juwell Amankwah", email: "olivia@example.com", courses: 1, status: "active" },
  ],
  mentors: [
